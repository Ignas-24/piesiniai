...
<body>
	...
	<form name="vartotojai" action="procadmin.php" method="post">
		...
		$stmt = mysqli_prepare($db, "SELECT slapyvardis, role, pilnas_vardas, gimtadienis, sukurta FROM " . TBL_USERS . " ORDER BY role DESC, slapyvardis");
		if (!$stmt) {
		...
		<table class="center" border="1" cellspacing="0" cellpadding="3">
			<tr>
				<td><b>Vartotojo slapyvardis</b></td>
				<td><b>Rolė</b></td>
				<td><b>Pilnas vardas</b></td>
				<td><b>Gimtadienis</b></td>
				<td><b>Sukurta</b></td>
				<td><b>Šalinti?</b></td>
			</tr>
			<?php
			while ($row = mysqli_fetch_assoc($result)) {
				...
				$fullname = $row['pilnas_vardas'];
				$birthday = $row['gimtadienis'];
				$created = $row['sukurta'];
