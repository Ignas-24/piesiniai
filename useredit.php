<?php
// useredit.php 
// vartotojas gali pasikeisti slaptažodį
                        ...
                        <tr>
                            <td>
                                <form action="procuseredit.php" method="POST" class="login">
                                    ...
                                    <center style="font-size:14pt;"><b>Vartotojas: <?php echo $_SESSION['user']; ?></b>
                                    </center>
                                    ...
                                    <p style="text-align:left;">Naujas slaptažodis:<br>
                                        <input class="s1" name="passn" type="password"
                                            value="<?php echo $_SESSION['passn_login']; ?>"><br>
